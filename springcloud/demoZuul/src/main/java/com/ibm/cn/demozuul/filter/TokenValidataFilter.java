package com.ibm.cn.demozuul.filter;

import com.alibaba.fastjson.JSONObject;
import com.ibm.cn.demozuul.config.NoAuthConfigurationBean;
import com.ibm.cn.demozuul.jwt.JwtTokenProvider;
...
public class TokenValidataFilter extends ZuulFilter {
    ...
    // 自定义的配置
    NoAuthConfigurationBean noAuthConfigurationBean;

    //初始化时，将我们的自定义配置加入
    public TokenValidataFilter(JwtTokenProvider jwtTokenProvider, NoAuthConfigurationBean noAuthConfigurationBean) {
        this.jwtTokenProvider = jwtTokenProvider;
        this.noAuthConfigurationBean = noAuthConfigurationBean;
    }
    ...
    public boolean shouldFilter() {
        ...
        return !noAuthConfigurationBean.getNoAuthoutes().contains(ctx.get("proxy"));
    }
    ...
    public Object run() throws ZuulException {
        ...
        // 可以将token内容输出出来看看
        System.out.println("The contents of Parsed token is ："+ JSONObject.toJSONString(claims));
