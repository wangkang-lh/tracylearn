package com.ibm.cn.demozuul.controller;

import com.ibm.cn.demozuul.jwt.JwtConfiguration;
import com.ibm.cn.demozuul.jwt.JwtTokenProvider;
import com.ibm.cn.demozuul.jwt.UAAClaims;
import com.ibm.cn.demozuul.model.JwtToken;
import com.ibm.cn.demozuul.model.User;
...
public class TokenController {
    ...
    public ResponseEntity<?> getTokenByPhone(@RequestBody User user) {
        ...
        return ResponseEntity.ok(new JwtToken(jwtTokenProvider.createToken(this.parseClaims(user))));
    }
